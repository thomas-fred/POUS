...
def process_raw_outage_data(csv_directory: str) -> pd.DataFrame:
    """
    Read all years of available data, drop superfluous columns, clip to bounds,
    concatenate.

    Args:
        directory: Location containing POUS outage CSV files.

    Returns:
        Processed outage records by time and county.
    """
